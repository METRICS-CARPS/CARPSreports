...
```{r}
articleID <- NA # insert the article ID code here e.g., "Ghi8O"
pilotName <- NA # insert the pilot's name here e.g., "Tom Hardwicke"
copilotName <- NA # insert the co-pilot's name here e.g., "Michael Frank"
...
pilotStartDate <- NA # insert the co-pilot's start date in US format e.g., as.Date("01/25/18", format = "%m/%d/%y")
...
# Use the reproReport() function in this code chunk.
...
# FOR EXAMPLE:
# reproReport(Report_Type = "pilot", 
#             Article_ID = "9-2-2015_PS", 
...
# REPLACE ALL NAs (if there were no issues assign a zero)
...
Affects_Conclusion <- NA # Do any reproduciiblity issues encounter appear to affect the conclusions made in the original article?
